...
import com.example.meuapp.ExercicioMusicas.Utils.OnClickListenerMusica
import com.example.meuapp.databinding.MusicaLayout2Binding
import com.example.meuapp.databinding.MusicaLayoutBinding


//Esse onCickListenerMusica(precisa criar a interface) e o OnCLickListener(função anonima) e os dois jeito que tem para poder acessar o fragment
// e fazer algo em cada card da lista
...
class MusicaAdapter(
    ...
    // Ensinando ao viewHolder oque fazer na tela
    // ViewHolder = pegar os dados do xml e setar nas telas
    class ViewHolder(
